...
if __name__ == '__main__':
  ...
  import pylab as plt
  resp = pickle.load(open("baxter_resp.pkl", "rb"))
...
#  test_y = testfunc_vec(test_x)
  test_x = resp.dmp_list[0].f_domain
  test_y = resp.dmp_list[0].f_targets
  
  # create LWR Model
  lwr = LWR(n_rfs=50, activation=0.1, cutoff=0.001, exponentially_spaced=False)
